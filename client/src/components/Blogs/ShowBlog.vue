<template>
    <div class="container">
      ...
      <div class="animal-details">
        ...
        <p v-if="blog.image"><strong>รูปภาพ:</strong></p>
        <img v-if="blog.image" :src="blog.image" alt="Animal Image" class="animal-image" />
      </div>
      <div class="button-group">
        <button v-on:click="navigateTo('/blog/edit/' + blog.id)" class="btn btn-primary">แก้ไข</button>
        <button v-on:click="navigateTo('/blogs')" class="btn btn-secondary">กลับ</button>
      </div>
    </div>
  </template>
